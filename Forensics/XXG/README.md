...
After trying to open the file in Gimp, it gave me an error `XCF error: unsupported XCF file version 14 encountered`. I then looked at some xcf created by me and found the common version as v011. So after changing the version, the final data was:
...
`MAPNA{F2FS_&_BFS_f1L3_5Ys73Ms_4rE_Nic3?!}`
